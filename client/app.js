...
const app = props => {
  ...
  return (
    <BrowserRouter>
      <Switch>
        <Route path={ROUTES.verify} render={() => <h1>A activation link has been sent, please check you Email </h1>} />
        <Route path={ROUTES.landing} render={localProps => <LandingPage {...localProps} />} />
        <Route path={ROUTES.signup} render={localProps => WithNavBar(<Signup {...localProps} />)} />
        <Route path={'/'} exact render={localProps => WithNavBar(<MainPage {...localProps} />)} />
